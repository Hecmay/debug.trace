    ...
    for (int c1 = 0; c1 <= 3; c1 += 1)
      for (int c2 = 0; c2 <= 1; c2 += 1) {
        ...
        for (int c3 = 0; c3 <= 12; c3 += 1) {
          // io_L2
          for (int c4 = 0; c4 <= 19; c4 += 1)
            for (int c5 = 0; c5 <= 511; c5 += 1)
              A_to[cnt++] = A_from[(260 * c0 + 20 * c3 + c4) * 1024 + (512 * c2 + c5)];
        }
      }
}
/* Helper Function */
      ...
      for (int c2 = 0; c2 <= 1; c2 += 1) {
        ...
        for (int c3 = 0; c3 <= 15; c3 += 1) {
          ...
          for (int c4 = 0; c4 <= 15; c4 += 1)
            for (int c5 = 0; c5 <= 511; c5 += 1)
              B_to[cnt++] = B_from[(256 * c1 + 16 * c3 + c4) * 1024 + (512 * c2 + c5)];
        }
      }
}
/* Helper Function */
        ...
        for (int c4 = 0; c4 <= 12; c4 += 1) {
          ...
          for (int c5 = 0; c5 <= 19; c5 += 1)
            for (int c6 = 0; c6 <= 15; c6 += 1)
              C_to[(260 * c0 + 20 * c4 + c5) * 1024 + (256 * c1 + 16 * c3 + c6)] = C_from[cnt++];
        }
      }
    }
}
